export default function AdminDashboard() {
  return (
    <div className="flex flex-col gap-8">
      <div>
        <h2 className="font-tnrc text-3xl uppercase tracking-tight mb-2">Welcome Back</h2>
      ...
      <div className="bg-neutral-950 border border-neutral-900 rounded-xl p-6 mt-8">
        <h3 className="font-mono text-xs text-neutral-400 uppercase tracking-widest mb-6">Recent Orders</h3>
