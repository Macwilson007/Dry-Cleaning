export default function AdminOrders() {
  return (
    <div className="flex flex-col gap-8">
      <div>
        <h2 className="font-tnrc text-3xl uppercase tracking-tight mb-2">Order Management</h2>
      ...
      <div className="bg-neutral-950 border border-neutral-900 rounded-xl p-6 mt-4">
        <div className="flex justify-between items-center mb-8 border-b border-neutral-900 pb-4">
          <h3 className="font-mono text-xs text-neutral-400 uppercase tracking-widest">All Orders</h3>
